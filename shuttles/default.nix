...
in {
  ...
  systemd.tmpfiles.rules = [
    ...
    "d /var/run/media/${username}/9b67994f-39ae-49c5-956b-c9ecdb685f9e1 0755 ${username} users"
    "d /var/run/media/${username}/cbce37c2-e57a-432c-9f0c-a85618d35ca7 0755 ${username} users"
    "L /home/${username}/zroot/shuttles/k1 - - - - /run/media/${username}/9b67994f-39ae-49c5-956b-c9ecdb685f9e1"
